NMAP=$(nmap -sP -PA21,22,25,554,3389 10.0.250.0/24) # set here the proper internal IP range
...
ldapadd -c -x -D "cn=admin,dc=nodomain" -w admin -f $FILE >> /tmp/scan.log 2>&1
